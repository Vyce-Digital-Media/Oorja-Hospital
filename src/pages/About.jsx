...
import { globalData, aboutData } from '../data/content';
...
export default function About() {
  ...
  return (
    <div className="pt-20 sm:pt-24 overflow-hidden bg-white text-slate-900">
      ...
      {/* 3. FACILITY HIGHLIGHTS — TEAL BACKGROUND */}
      <section className="py-16 sm:py-24 bg-teal-500 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-12">
            <p className="text-teal-100 text-xs font-bold uppercase tracking-widest mb-2">Our Capabilities</p>
            ...
            {aboutData.highlights.map((highlight, idx) => {
              ...
              return (
                <motion.div
                  ...
                  className="bg-white/10 hover:bg-white/20 border border-white/20 rounded-2xl p-6 transition-all duration-300 hover:-translate-y-1 backdrop-blur-sm flex flex-col gap-4"
                >
                  <div className="w-12 h-12 rounded-xl bg-white/20 flex items-center justify-center flex-shrink-0">
                    <IconComp className="w-6 h-6 text-white" />
                  </div>
                  <p className="text-white font-semibold text-sm sm:text-base leading-relaxed">{highlight}</p>
                  <div className="mt-auto pt-3 border-t border-white/20 flex items-center justify-between text-xs font-bold text-white/60 uppercase tracking-wider">
