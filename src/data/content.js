...
export const gastroServicesData = {
  ...
  services: [
    ...
    },
    {
      ...
      image: "/obesity-consultation.jpg",
      iconName: "Scale",
    },
    {
      id: 4,
      ...
      image: "/pancreatobiliary-ercp.jpg",
...
export const fetalServicesData = {
  ...
  services: [
    ...
    },
    {
      ...
      description: "Detailed monitoring of twin and triplet pregnancies as to ensure a safer journey for the mother as well as the babies.",
      image: "/service-8.jpg",
      iconName: "Users",
    },
    {
    ...
    },
    {
      ...
      description: "Specialized procedures for early diagnosis of genetic and chromosomal conditions such as Amniocentesis, Chorionic Villous Sampling, Fetal Reductions etc.",
...
export const aboutData = {
  ...
  bodyCopy: "Led by Dr Harsh Jain and Dr Ishita Agarwal, the centre focuses on creating a trusted healthcare environment where patients can receive personalised attention, evidence based treatment and ethical care.",
  highlights: [
